...
grep -A$offst2 -m1 "orbital moment"  OUTCAR > temp.txt   # to create a file with required magnetization of last iteration
...
#paste POSCAR.mcif orbital_POSCAR.mcif | tail -$(($q-1)) | awk '{print $1,$2+$6,$3+$7,$4+$8}' > temp3.txt
