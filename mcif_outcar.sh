...
echo "NION= " $NION
offst1=$((($NION*4)+40))            # offset or the region to look for in OUTCAR
...
#        	echo -n -e "\t"$m>>POSCAR.mcif
        ...
        echo -n -e "\t |m| : $(tail -1 POSCAR.mcif| awk '{print sqrt($2^2+$3^2+$4^2)}'|bc -l)"
#       echo -n -e "\t Theta in x-z Plane: $(tail -1 POSCAR.mcif| awk '{print atan2 ($4,$2) * 180 / 3.14159265359}'|bc -l)"
